...
var initPlugin = function initPlugin(player, options) {
  ...
  var onErrorHandler = function onErrorHandler() {
    ...
    if (error.message) {
      ...
      details = '<div class="vjs-errors-details"><div class="vjs-errors-message">' + player.localize(error.message) + '</div>\n        </div>';
    }
    ...
    dialogContent = '<div class="vjs-errors-content-container">' + details + '</div>';
